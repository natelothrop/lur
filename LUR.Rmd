...
######NO2 test for how many homes have measures in multiple seasons and multiple years:
```{r, echo=FALSE, message=FALSE, warning=FALSE}
...
pm25_ref_replaceavg$ratio <- pm25_ref_replaceavg$mon/pm25_ref_replaceavg$year

# the ratio is coming out weird - what's up with that?
