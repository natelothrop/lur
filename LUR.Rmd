...
There are simply not enough data points to impute or rather extrapolate on the early end of PM2.5 data. As per discussion with Paloma on 2/13/19 in office hours, we'll simply exclude these data that do not have a reference background monitor (ie anything before June 1988).
