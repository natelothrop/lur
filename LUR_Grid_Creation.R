...
roads_vehicletype <- st_read("Roads_VehicleType_80_92.shp", stringsAsFactors = F)
...
roads_vehicletype <- roads_vehicletype  %>% st_set_crs(NA) %>% st_set_crs(2868)
...
st_transform(roads_vehicletype, crs = 2868)
